...
export default class InputToolbar extends React.Component<InputToolbarProps, {
    ...
    static propTypes: {
        ...
        primaryStyle: PropTypes.Validator<import("react-native").StyleProp<ViewStyle>> | undefined;
        accessoryStyle: PropTypes.Validator<import("react-native").StyleProp<ViewStyle>> | undefined;
    };
    state: {
        position: string;
    };
