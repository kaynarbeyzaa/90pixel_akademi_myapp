...
var e=document.createElement("h2");e.classList.add("mdl-card__title-text");e.textContent=b.shortName||b.name;d.appendChild(e);if(b.iconUri){d=document.createElement("picture");e=document.createElement("source");e.srcset=b.iconUri.replace(/.png$/,".webp");e.type="image/webp";var f=document.createElement("source");f.srcset=b.iconUri;f.type="image/png";var g=document.createElement("img");g.src=b.iconUri;g.alt="";d.appendChild(e);d.appendChild(f);d.appendChild(g);this.card_.appendChild(d)}b.description&&
...
b.storedProgress);c.appendChild(this.progressBar_);this.card_.appendChild(c);a.appendChild(this.card_);this.remakeButtons()};AssetCard.prototype.addFeatureIcon_=function(a,b){var c=document.createElement("div");c.classList.add("feature-icon");c.setAttribute("icon",a);this.featureIconsContainer_.appendChild(c);ShakaDemoTooltips.make(c,b)};
...
AssetCard.prototype.makeUnsupportedButton_=function(a,b){var c=this.addButton(a,function(){});c.setAttribute("disabled","");if(b){var d=document.createElement("div");c.parentElement&&c.parentElement.removeChild(c);d.classList.add("tooltip-attach-point");d.appendChild(c);this.actions_.appendChild(d);ShakaDemoTooltips.make(d,b)}return c};AssetCard.prototype.selectByAsset=function(a){this.card_.classList.remove("selected");this.asset_==a&&this.card_.classList.add("selected")};
AssetCard.prototype.remakeButtons=function(){shaka.ui.Utils.removeAllChildren(this.actions_);this.remakeButtonsFn_(this)};
AssetCard.prototype.addStoreButton=function(){var a=this,b=function(a,b,c){b.classList.add("asset-card-corner-button");b=document.createElement("i");b.textContent=c;b.classList.add("material-icons");a.appendChild(b)},c=shakaDemoMain.getAssetUnsupportedReason(this.asset_,!0);if(c||!this.asset_.storeCallback)c=this.makeUnsupportedButton_("",c),b(c,c.parentElement||c,"get_app");else if(this.asset_.isStored()){var d=this.addButton("",function(){a.makeDeleteDialog_(d)});b(d,d,"offline_pin")}else{var e=
this.addButton("",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function g(){return $jscomp.generator.createGenerator(g,function(b){switch(b.nextAddress){case 1:return e.disabled=!0,b.yield(a.asset_.storeCallback(),2);case 2:a.remakeButtons(),b.jumpToEnd()}})})});b(e,e,"get_app")}};
AssetCard.prototype.makeDeleteDialog_=function(a){var b=this,c=this.card_.parentElement;if(c){var d=document.createElement("dialog");d.classList.add("mdl-dialog");c.appendChild(d);d.showModal||dialogPolyfill.registerDialog(d);c=document.createElement("h2");c.classList.add("mdl-typography--title");c.textContent="Delete the offline copy?";d.appendChild(c);var e=document.createElement("div");d.appendChild(e);c=function(a,b){var c=document.createElement("button");c.textContent=a;c.classList.add("mdl-button");
...
ShakaDemoConfig.prototype.addOfflineSection_=function(){var a=this.resolveExternLink_(".OfflineConfiguration");this.addSection_("Offline",a).addBoolInput_("Use Persistent Licenses","offline.usePersistentLicense")};
...
debug:"Debug",v:"Verbose",vv:"Very Verbose"},function(a){switch(a.value){case "info":c(b.INFO);break;case "debug":c(b.DEBUG);break;case "vv":c(b.V2);break;case "v":c(b.V1)}shakaDemoMain.remakeHash()});var d=this.latestInput_.input();switch(shaka.log.currentLevel){case b.DEBUG:d.value="debug";break;case b.V2:d.value="vv";break;case b.V1:d.value="v";break;default:d.value="info"}}};ShakaDemoConfig.prototype.resolveExternLink_=function(a){return"../docs/api/shaka.extern.html#"+a};
...
!1,function(){b.dialog_.close()}));componentHandler.upgradeDom();this.dialog_.showModal()};ShakaDemoCustom.prototype.loadAssetInfos_=function(){var a=window.localStorage.getItem(ShakaDemoCustom.saveId_);return a?(a=JSON.parse(a),new Set(a.map(function(a){a=ShakaDemoAssetInfo.fromJSON(a);shakaDemoMain.setupOfflineSupport(a);return a}))):new Set};ShakaDemoCustom.prototype.saveAssetInfos_=function(a){var b=ShakaDemoCustom.saveId_;a=Array.from(a);window.localStorage.setItem(b,JSON.stringify(a))};
...
function(b,d){for(var e in b){var g=e,k=d+e;if(!c.includes(k)){f.includes(e)&&(g=k);var l=b[e];"number"==typeof l||"string"==typeof l||"boolean"==typeof l?a(g,k):h(l,k+".")}}};h(b,"")},browserSupportsUncompiledMode:function(){try{return eval("async ()=>{}"),!0}catch(a){return!1}}};var shakaDemoFront,ShakaDemoFront=function(a){var b=this;this.assetCards_=[];this.messageDiv_=document.createElement("div");this.assetCardDiv_=document.createElement("div");a.appendChild(this.messageDiv_);this.makeMessage_();a.appendChild(this.assetCardDiv_);document.addEventListener("shaka-main-selected-asset-changed",function(){b.updateSelected_()});document.addEventListener("shaka-main-offline-progress",function(){b.updateOfflineProgress_()});document.addEventListener("shaka-main-page-changed",
function(){b.assetCardDiv_.childNodes.length||a.classList.contains("hidden")||b.remakeAssetCards_()})};ShakaDemoFront.init=function(){var a=shakaDemoMain.addNavButton("front");shakaDemoFront=new ShakaDemoFront(a)};
...
ShakaDemoFront.prototype.remakeAssetCards_=function(){var a=this;shaka.ui.Utils.removeAllChildren(this.assetCardDiv_);this.assetCards_=shakaAssets.testAssets.filter(function(a){return a.isFeatured&&!a.disabled}).map(function(b){return a.createAssetCardFor_(b,a.assetCardDiv_)});this.updateSelected_()};
...
ShakaDemoMain.prototype.init=function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function c(){var d,e,f,g;return $jscomp.generator.createGenerator(c,function(c){switch(c.nextAddress){case 1:return a.initCommon_(),d=a,c.yield(shaka.Player.probeSupport(),2);case 2:d.support_=c.yieldResult;a.video_=document.getElementById("video");a.video_.poster=ShakaDemoMain.mainPoster_;a.container_=document.getElementsByClassName("video-container")[0];if(!navigator.serviceWorker){c.jumpTo(3);
...
null;c.jumpTo(3);break;case 4:for(var h=$jscomp.makeIterator(shakaAssets.testAssets),k=h.next();!k.done;k=h.next())g=k.value,a.getAssetUnsupportedReason(g,!0)||a.setupOfflineSupport(g);c.jumpToEnd()}})})};ShakaDemoMain.prototype.hashChanged_=function(){this.readHash_();this.dispatchEventWithName_("shaka-main-config-change")};
...
l.insert(a,h);d.jumpToEnd()}})})};ShakaDemoMain.prototype.setUILocale=function(a){this.uiLocale_=a;a=[a].concat(navigator.languages);this.controls_.getLocalization().changeLocale(a)};ShakaDemoMain.prototype.getUILocale=function(){return this.uiLocale_};
ShakaDemoMain.prototype.getLastAssetFromHash_=function(){var a=this.getParams_(),b=a.asset;if(b){for(var c=$jscomp.makeIterator(shakaAssets.testAssets),d=c.next();!d.done;d=c.next())if(d=d.value,d.manifestUri==b)return d;c=$jscomp.makeIterator(shakaDemoCustom.assets());for(d=c.next();!d.done;d=c.next())if(d=d.value,d.manifestUri==b)return d;b=new ShakaDemoAssetInfo("loaded asset","",b,shakaAssets.Source.UNKNOWN);if("license"in a)for(c=ShakaDemoMain.commonDrmSystems,("drmSystem"in a)&&(c=[a.drmSystem]),
...
f.addEventListener("click",function(b){return function(){var c=location.hash.substr(1).split(";").filter(function(a){return"compiled"!=a&&"build"!=a.split("=")[0]});c.push("build="+b.type);a.setNewHashSilent_(c.join(";"));location.reload();return!1}}(d)));this.nativeControlsEnabled_="nativecontrols"in b;ShakaDemoUtils.browserSupportsUncompiledMode()||(c=document.getElementById("uncompiled-link"),c.setAttribute("disabled",""),c.removeAttribute("href"),c.title="requires a newer browser");shaka.log&&
("vv"in b?shaka.log.setLevel(shaka.log.Level.V2):"v"in b?shaka.log.setLevel(shaka.log.Level.V1):"debug"in b?shaka.log.setLevel(shaka.log.Level.DEBUG):"info"in b&&shaka.log.setLevel(shaka.log.Level.INFO))};ShakaDemoMain.prototype.getParams_=function(){var a=location.search.substr(1);a=a?a.split(";"):[];var b=location.hash.substr(1);b=b?b.split(";"):[];a=a.concat(b);b={};for(var c=0;c<a.length;++c){var d=a[c].split("=");b[d[0]]=d.slice(1).join("=")}return b};
ShakaDemoMain.prototype.getValueFromGivenConfig_=function(a,b){for(var c=b,d=a;d;){var e=d.split(/\.(.+)/);if(3==e.length)d=e[1],c=c[e[0]];else return c[e[0]]}};ShakaDemoMain.prototype.getCurrentConfigValue=function(a){return this.getValueFromGivenConfig_(a,this.desiredConfig_)};ShakaDemoMain.prototype.resetConfiguration=function(a){this.configure(a,void 0)};
ShakaDemoMain.prototype.configure=function(a,b){2==arguments.length&&"string"==typeof a&&(a=shaka.util.ConfigUtils.convertToConfigObject(a,b));shaka.util.PlayerConfiguration.mergeConfigObjects(this.desiredConfig_,a,this.defaultConfig_);this.player_.configure(a,b)};ShakaDemoMain.prototype.getConfiguration=function(){return this.desiredConfig_};
...
ShakaDemoMain.prototype.unload=function(){this.selectedAsset=null;var a=document.getElementById("video-bar");this.hideNode_(a);this.video_.poster=ShakaDemoMain.mainPoster_;this.player_.unload();this.dispatchEventWithName_("shaka-main-selected-asset-changed");this.remakeHash()};
ShakaDemoMain.prototype.drmConfiguration_=function(a,b){var c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){var f,g,h,l,k,n,q;return $jscomp.generator.createGenerator(e,function(e){switch(e.nextAddress){case 1:f=b?b.getNetworkingEngine():c.player_.getNetworkingEngine();goog.asserts.assert(f,"There should be a net engine.");a.applyFilters(f);g=a.getConfiguration();b?b.configure(g):(c.player_.configure(c.desiredConfig_),c.player_.configure(g));h=b?b.getConfiguration():c.player_.getConfiguration();
...
h.drm.advanced),c.remakeHash(),e.jumpToEnd()}})})};ShakaDemoMain.prototype.showPlayer_=function(){var a=document.getElementById("video-bar");this.showNode_(a);this.closeError_();this.video_.poster=ShakaDemoMain.mainPoster_;a.scrollIntoView({behavior:"smooth",block:"start"})};
...
ShakaDemoMain.prototype.dispatchEventWithName_=function(a){var b=document.createEvent("CustomEvent");b.initCustomEvent(a,!1,!1,null);document.dispatchEvent(b)};
